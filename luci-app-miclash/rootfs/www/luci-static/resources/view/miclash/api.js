...
const METHOD_SPECS = [
	...
	{ name: 'config_read_draft', params: ['profile'], operation: false },
	{ name: 'config_save_draft', params: ['profile', 'content', 'source'], operation: true },
	...
	{ name: 'operational_settings_apply', params: ['profile', 'content', 'settings', 'source'], operation: true },
	{ name: 'config_swap', params: ['profile', 'source'], operation: true },
	...
	{ name: 'guard_transition', params: ['enabled', 'source'], operation: true },
	...
	{ name: 'history_open_draft', params: ['profile', 'revision', 'source'], operation: true },
	...
	{ name: 'devices_timezones', params: [], operation: false },
	...
	{ name: 'logs_read', params: ['generation', 'cursor', 'limit'], operation: false },
	{ name: 'system_info', params: [], operation: false },
	{ name: 'network_interfaces', params: [], operation: false },
	{ name: 'ruleset_list', params: [], operation: false },
	{ name: 'ruleset_read', params: ['name'], operation: false },
	{ name: 'ruleset_write', params: ['name', 'content', 'source'], operation: true },
	{ name: 'ruleset_delete', params: ['name', 'source'], operation: true },
	{ name: 'ruleset_apply_whitelist', params: ['content', 'source'], operation: true },
