...
const METHOD_SPECS = [
	...
	{ name: 'update_miclash', params: ['channel', 'source', 'action', 'version'], operation: true, access: 'write' },
	{ name: 'update_mihomo', params: ['channel', 'source', 'action', 'version'], operation: true, access: 'write' },
	...
	{ name: 'runtime_metrics', params: [], operation: false, access: 'read' },
...
function createClient(options) {
	...
	Object.assign(client, {
		...
		runtimeMetrics: client.runtime_metrics,
