...
check(nftClient.includes('guard_effective_enabled') &&
	!nftClient.includes('INTERNET_ONLY_MICLASH'),
	'nft client proxy-server exclusions must use effective UCI-or-latch Guard state.');
...
check(iptablesClient.includes('guard_effective_enabled') &&
	!iptablesClient.includes('INTERNET_ONLY_MICLASH'),
	'iptables client proxy-server exclusions must use effective UCI-or-latch Guard state.');
