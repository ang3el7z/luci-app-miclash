...
Скрипт сам выбирает новейший полностью готовый стабильный v2 release среди 20 последних и проверяет installer, checksum и publication manifest до удаления v0.9.x:
